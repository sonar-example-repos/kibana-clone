      ...
      input: z.object({
        ...
        pageSize: z
          .preprocess(
            ...
            z.coerce.number().optional().default(DEFAULT_PAGE_SIZE)
          )
    ...
    listFiles: {
      ...
      input: z.object({
        folderId: z
          .preprocess(
            (val) => (val === '' || val === 'undefined' ? undefined : val),
            z.string().optional().default(DEFAULT_FOLDER_ID)
          )
      ...
      handler: async (ctx, input) => {
        ...
        try {
          ...
          if (isGoogleDoc) {
            ...
            const exportMimeType = typedInput.mimeType || DEFAULT_EXPORT_MIME_TYPE;
          ...
          // Convert ArrayBuffer to base64 string for easier handling
