...
export function getMarkdownClient<
  Attr extends SerializableAttributes = SerializableAttributes
>(): VisualizationClient<typeof MARKDOWN_EMBEDDABLE_TYPE, Attr> {
  return markdownClient as unknown as VisualizationClient<typeof MARKDOWN_EMBEDDABLE_TYPE, Attr>;
}
