...
import { ENDPOINT_DESCRIPTIONS, SERVICE_PROVIDERS } from '@kbn/inference-endpoint-ui-common';
...
export const useCompatibleInferenceEndpoints = (
  ...
  const compatibleEndpoints = useMemo<CompatibleEndpointsData | undefined>(() => {
    ...
    endpoints?.forEach((endpoint) => {
      ...
      const description =
        ENDPOINT_DESCRIPTIONS[endpoint.service] ?? endpoint.service_settings.model_id;
      const isElserInEis =
