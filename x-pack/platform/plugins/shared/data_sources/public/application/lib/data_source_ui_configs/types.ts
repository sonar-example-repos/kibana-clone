 ...
 *
 * Note: Serializer types use default generics (Record<string, unknown>) to match
 * the pattern used by other Kibana connectors (OpenAI, Inference, etc.).
 * Type safety is maintained through internal casts within the serializer implementations.
 */
